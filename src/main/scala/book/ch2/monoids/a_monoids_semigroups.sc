...
object a_monoids_semigroups {
  println("Welcome to the Scala worksheet")       //> Welcome to the Scala worksheet
	...
	*/
	...
	val intSetMonoid = Monoid[Set[Int]]       //> intSetMonoid  : cats.kernel.Monoid[Set[Int]] = cats.kernel.instances.SetSem
                                                  //| ilattice@20e2cbe0

	intSetMonoid.combine(Set(1, 2), Set(2, 3))//> res16: Set[Int] = Set(1, 2, 3)
	...
	*/
		...
		}                                 //> symDiffMonoid: [A]=> cats.Monoid[Set[A]]
	/*
    ---------------------------------------------------------------
		2.5 Monoids in Cats
	...
	*/
		...
		Monoid[String].combine("Hi ", "there")
                                                  //> res17: String = Hi there

		Monoid[String].empty              //> res18: String = ""
	...
	*/
		...
		Monoid.apply[String].empty        //> res20: String = ""
	...
	*/
		...
		Monoid[Int].combine(32, 10)       //> res22: Int = 42
	...
	*/
		...
		Monoid[Option[Int]].combine(a, b) //> res23: Option[Int] = Some(42)
	...
	*/
		...
		def add(items: List[Int]): Int =
			items.foldLeft(0)(_ + _)  //> add: (items: List[Int])Int
	...
	*/
		...
		def add3[A](items: List[A])(implicit monoid: Monoid[A]): A =
			items.foldLeft(monoid.empty)(_ |+| _)
                                                  //> add3: [A](items: List[A])(implicit monoid: cats.Monoid[A])A
		...
		*/
		...
		add4(List(1, 2, 3))               //> res24: Int = 6

		import cats.instances.option._ // for Monoid
		
		add4(List(Some(1), None, Some(2), None, Some(3)))
                                                  //> res25: Option[Int] = Some(6)
...
*/
		...
		"Scala" |+| " with " |+| "Cats"   //> res26: String = Scala with Cats
	...
	*/
		...
		Option(1) |+| Option(2)           //> res27: Option[Int] = Some(3)
		...
		map1 |+| map2                     //> res28: Map[String,Int] = Map(b -> 5, d -> 4, a -> 1)
		...
		tuple1 |+| tuple2                 //> res29: (String, Int) = (helloworld,444)
	...
	*/
		...
		def addAll[A](values: List[A])
			...
			values.foldRight(monoid.empty)(_ |+| _)
                                                  //> addAll: [A](values: List[A])(implicit monoid: cats.Monoid[A])A

		addAll(List(1, 2, 3))             //> res30: Int = 6
