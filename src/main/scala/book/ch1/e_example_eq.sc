...
object e_example_eq {
	...
	*/
		...
		val eqInt = Eq[Int]               //> eqInt  : cats.kernel.Eq[Int] = cats.kernel.instances.IntOrder@ae45eb6
	/*
		We can use eqInt directly to test for equality:
	*/
		
		eqInt.eqv(123, 123)               //> res1: Boolean = true
		eqInt.eqv(123, 234)               //> res2: Boolean = false
	/*
...
//		eqInt.eqv(123, "234")
	...
	*/
		...
		123 === 123                       //> res3: Boolean = true

		123 =!= 234                       //> res4: Boolean = true
...
*/
		Option(1) === Option.empty[Int]   //> res6: Boolean = false
	...
	*/
		...
		1.some === none[Int]              //> res7: Boolean = false

		1.some =!= none[Int]              //> res8: Boolean = true
	...
	*/
		...
		optionCat1 =!= optionCat2         //> res14: Boolean = true
