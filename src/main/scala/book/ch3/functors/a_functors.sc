 ...
 */
  ...
  */
		...
		doMath(Option(20))                //> res9: Option[Int] = Some(22)
	
		doMath(List(1, 2, 3))             //> res10: List[Int] = List(3, 4, 5)
...
*/
  ...
  /*
	...
	*/
		...
		format(Box("hello world"))        //> res15: String = "hello world"
		// res5: String = "hello world"
		format(Box(true))                 //> res16: String = yes
		// res6: String = yes
	/*
  ...
  */
		...
		encode(123.4)                     //> res17: String = 123.4


		decode[Double]("123.4")           //> res18: Double = 123.4
  ...
  /*
	...
	*/
		...
		'a |+| 'few |+| 'words            //> res24: Symbol = 'afewwords
...
/*
	...
	*/
		...
		either.map(_ + 1)                 //> res25: scala.util.Either[String,Int] = Right(124)
	/*
